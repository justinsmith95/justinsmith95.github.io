            ...
            <Collapse in={open}>
                <div className="AboutMe">
                    <Row md={12} xs={12} xl={12} lg={12} >
                       ...
                       Other than web-development, my hobbies and interests include spending time with friends, watching way too many movies, playing tennis, and most importantly, video games. 
                           </p>
